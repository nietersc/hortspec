...
[![R-CMD-check](https://github.com/nietersc/hortspec/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/nietersc/hortspec/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
